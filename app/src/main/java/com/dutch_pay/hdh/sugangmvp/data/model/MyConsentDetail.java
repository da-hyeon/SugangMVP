...
public class MyConsentDetail {

    private String name;
    private ArrayList<MyConsentDetailResultData> data;
    ...
    public ArrayList<MyConsentDetailResultData> getData() {
        return data;
    }

    public void setData(ArrayList<MyConsentDetailResultData> data) {
        this.data = data;
    }

    public static class MyConsentDetailResultData {
